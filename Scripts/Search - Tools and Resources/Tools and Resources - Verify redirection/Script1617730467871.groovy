...
WebUI.click(findTestObject('Object Repository/Page_Resources/li_Article'))

WebUI.click(findTestObject('Object Repository/Page_Resources/button_Apply'))

List ResourceSearchResultLinks = CustomKeywords.'velir.utilities.GetLinksFromSection'(findTestObject('Object Repository/Page_Resources/div_search__results_search__results--resources'))
