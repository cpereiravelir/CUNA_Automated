...
ActiveFacetsObjectText = WebUI.getText(findTestObject('Object Repository/Page_Find a Solution/div_Active_facets_label'))

println(ActiveFacetsObjectText)

if (!(ActiveFacetsObjectText.contains('Security'))) {
	KeywordUtil.markFailedAndStop('Security is not visible, so the test is failed!')
}


'Clear the filters selected'

WebUI.click(findTestObject('Object Repository/Page_Find a Solution/button_clear filters'))
