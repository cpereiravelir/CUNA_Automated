...
ResultsLabelElement = driver.findElement(By.xpath('//*[@id="solutionsearch-2a0531f2b2"]/div[1]/div/div/div[2]/div[2]/p'))
 ...
 WebUI.click(findTestObject('Object Repository/Page_Find a Solution/button_Alliance Provider'))
 
 WebUI.click(findTestObject('Object Repository/Page_Find a Solution/li_2020 Analytics'))
